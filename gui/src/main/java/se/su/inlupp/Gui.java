...
public class Gui extends Application {
    ...
    private Scene buildTrainScene(Stage stage) {
        this.stage = stage;
    ...
    private void saveAndExit(Event e) {
    ...
    private class ChangeBackgroundButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent actionEvent) {
    ...
    private class SpawnNode implements EventHandler<MouseEvent> {
        @Override
    ...
    private class PathLibraryButtonHandler implements EventHandler<ActionEvent> {
        @Override
    ...
    private class ButtonActiveHandler implements ChangeListener<String> {
        @Override
    ...
    private class AddCityButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent actionEvent) {
            openMenu();
    ...
    private class LinkCitiesButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent e) {
    ...
    private class CreatePathButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent actionEvent) {
    ...
    private class RemoveCityButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent actionEvent) {
    ...
    private class SaveScreenShotButtonHandler implements EventHandler<ActionEvent> {
        @Override
        public void handle(ActionEvent actionEvent) {
            try{
    ...
    public void changeDetected(){cantSave.set(false);}

    public BackendControl getBackend(){return backendControl;}
